...
import { User, Menu, Youtube, Instagram, BookOpen } from "lucide-react";
...
const IFAB_LAWS_URL = "https://www.theifab.com/"
          ...
          <SheetContent side="left" className="w-[280px] sm:max-w-[85vw] p-0 flex flex-col">
            ...
            <div className="p-4 border-t border-border flex items-center gap-2 shrink-0">
              ...
              <a
                ...
                aria-label="IFAB Laws of the Game"
              >
              ...
              <SheetTrigger asChild>
                ...
                >
                  ...
                  <div className="relative shrink-0">
                    ...
                    {user.supportingTeam?.emblemPath && (
                      <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-white rounded-full border border-zinc-200 flex items-center justify-center p-0.5 shadow-lg z-10 overflow-hidden">
                        <Image
                          src={user.supportingTeam.emblemPath}
                          alt=""
                          width={20}
