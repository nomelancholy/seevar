  ...
  return (
    <main className="max-w-5xl mx-auto pb-12 md:pb-16">
      ...
      <p className="font-mono text-xs text-muted-foreground mb-6">
        등록된 댓글 목록입니다. Moderation API 점수(작성 시 기록)를 확인하고, 숨김 처리 또는 귀여운 댓글로 바꾸기를 할 수 있습니다. 처리 시 작성자에게 알림이 갑니다.
      ...
      <AdminCommentList comments={comments as Parameters<typeof AdminCommentList>[0]["comments"]} />
    </main>
  )
}
